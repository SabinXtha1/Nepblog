    ...
    <div className="max-w-3xl mx-auto border rounded-2xl">
      <div className="rounded-2xl bg-black text-white p-8 overflow-hidden">
        <div className="space-y-4">
          {/* Category skeleton */}
          <div className="inline-block w-28 h-8 rounded-full bg-zinc-900 animate-pulse"></div>

          {/* Title skeleton */}
          <div className="space-y-2">
            <div className="h-8 bg-zinc-900 rounded-md w-full animate-pulse"></div>
            <div className="h-8 bg-zinc-900 rounded-md w-3/4 animate-pulse"></div>
          </div>
          ...
          <div className="w-28 h-6 bg-zinc-900 rounded animate-pulse"></div>
        </div>

        {/* Pagination dots skeleton */}
        <div className="flex items-center justify-center gap-2 mt-8">
          {[0, 1, 2, 3, 4, 5, 6, 7].map((i) => (
            <div key={i} className="w-2 h-2 rounded-full bg-zinc-900 animate-pulse"></div>
          ))}
        </div>
      </div>
    </div>
